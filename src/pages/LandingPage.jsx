    ...
    <React.Fragment>
      {!isMobile && (
        <div
          ...
          id="container"
          onMouseEnter={() => toggleWindow()}
          onMouseLeave={() => toggleWindow()}
        >
          <div
          ...
          >
            <h4>Om Daniel</h4>
            <h4 style={{ position: "absolute", top: "25%" }}>
              Utvalgte Prosjekter
            </h4>
            <Button
              variant="contained"
          ...
          <div className="split right">
            <h4 style={{ color: "black", position: "absolute", top: "15%" }}>
              Audio
            </h4>
            <h4 style={{ color: "black", position: "absolute", top: "20%" }}>
              Film
            </h4>
            <h4 style={{ color: "black", position: "absolute", top: "24.5%" }}>
              Tidligere Arbeid
            </h4>
            <h4 style={{ color: "black", position: "absolute", top: "30%" }}>
              Utleie
            </h4>
            <Button
              className="button"
